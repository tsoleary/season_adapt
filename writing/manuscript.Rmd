...
Quantitative genetic theory suggests that plasticity occurs in response to selective pressure exerted by environmental heterogeneity [@Cooper2010].  Phenotypic plasticity is especially beneficial in variable environments because genetic variability allows for adaptation to changing conditions [@Gulisija2016]. Fluctuating selection can maintain polymorphisms in seasonal environments if strong selective pressure towards both homozygous genotypes varies seasonally [@Novak2017, @Bergland2014]. Understanding the role of seasonality on adaptation can allow more accurate predictions to be made about the capacity for organisms to adapt to climate change conditions [@Fournier-Level2016]. 
...
Our model recreates and builds upon the work of @Wittmann2017 to understand how linkage disequilibrium contributes to maintaining polymorphisms in a natural population. We study how rate of crossover, epistasis, allelic dominance, and seasonal balance contributes to segregation lift. 
...
```{r, fig.height = 3, fig.width = 5, fig.cap = 'A density plot of the allele frequencies at the final generation for five replicates of each value of the epistatis parameter. \\label{cross_density}', message = FALSE, echo = FALSE}
...
```{r, fig.height = 3, fig.width = 5, fig.cap = 'A density plot of the allele frequencies at the final generation for five replicates of each number of generations per year. \\label{sb_density}', message = FALSE, echo = FALSE}
